...
Deno.test("Proxy Function - Feature Flags", () => {
    const url = new URL("https://proxy.deno.dev/?url=https://youtube.com/watch?v=VIDEO_ID&extract_video=true&download=true&max_size=50");
...
Deno.test("Proxy Function - CORS Headers", () => {
    ...
    corsHeaders.set('Access-Control-Allow-Headers', 'Content-Type, Authorization, User-Agent, X-Forwarded-For');
